...
G'ildirakni boshqattan kashf qilish kerak emas, shunchaki ushbu qollanmaga amal qiling. [Futurice](http://www.futurice.com) jamoasi Android dasturchilari tajribasidan. Agarda siz iOS yoki Windows Phone dasturlashga qiziqsangiz, bizning [**iOS Good Practices**](https://github.com/futurice/ios-good-practices) va [**Windows App Development Best Practices**](https://github.com/futurice/windows-app-development-best-practices)mizga murojat qilishingiz mumkin.
...
#### [Gradle va taklif qilingan proyekt strukturasini ishlating.](#build-system)
#### [Kalitli soz(password) va maxfiy malumotlarni gradle.properties da saqlang.](#gradle-configuration)
#### [Json malumotlarni tarjima qilish uchun Jackson kutubxonasini ishlating.](#libraries)
#### [O'zingiz HTTP mijoz yozmang OkHttp kutubxonasini ishlating.](#networklibs)
#### [*65ming funksiya* cheklovidan oshib ketmaslik uchun, ko'p kutubxonalar va Guava ishlatishdan qoching.](#methodlimitation)
#### [Activity yoki Fragment dan birini tanlashda ehtiyot bo'ling.](#activities-and-fragments)
#### [Layout XMLlar ham kod, ularni ham yaxshi tashkil qiling.](#resources)
#### [Layout XMLlarda takrorlashni oldini olish uchun, stillarni ishlating.](#styles)
...
#### [Hardoim ProGuard yoki DexGuardni ishlating](#proguard-configuration)
#### [Kichik malumotlar uchun SharedPreferences ni ishlating, boshqa holatlarda esa ContentProvidersUseni.](#data-storage)
#### [Nosozliklarni tuzatish uchun Stetho dan foydalaning.](#use-stetho)
#### [Use Leak Canary to find memory leaks](#use-leakcanary)
#### [Doimiy Integratsiya(continuous integration)dan foydalaning.](#use-continuous-integration-1)
